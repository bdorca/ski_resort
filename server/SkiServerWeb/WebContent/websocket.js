...
function onMessage(event) {
    ...
    if (lift.action === "toggle") {
        ...
        if (lift.status === "On") {
            statusText.innerHTML = "Status: " + lift.status + " (<a href=\"#\" OnClick=toggleLift(" + lift.id + ")>Turn off</a>)";
        } else if (lift.status === "Off") {
            statusText.innerHTML = "Status: " + lift.status + " (<a href=\"#\" OnClick=toggleLift(" + lift.id + ")>Turn on</a>)";
        }
    }
...
function printLiftElement(lift) {
    ...
    if (lift.status === "On") {
        liftStatus.innerHTML = "<b>Status:</b> " + lift.status + " (<a href=\"#\" OnClick=toggleLift(" + lift.id + ")>Turn off</a>)";
    } else if (lift.status === "Off") {
        liftStatus.innerHTML = "<b>Status:</b> " + lift.status + " (<a href=\"#\" OnClick=toggleLift(" + lift.id + ")>Turn on</a>)";
    ...
    removeLift.innerHTML = "<a href=\"#\" OnClick=removeLift(" + lift.id + ")>Remove lift</a>";
